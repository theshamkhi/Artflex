...
$articles = $user->getArts();

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cat_id'], $_POST['action'])) {
    $catID = $_POST['cat_id'];
    $action = $_POST['action'];
    $user->updateArtStatus($catID, $action);
...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <div class="flex flex-col">
        ...
        <ul class="space-y-2 font-medium px-3 pb-4">
            ...
            <li>
                <a href="adminArticles.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
...
<footer class="bg-gray-100 sm:ml-80">
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="flex justify-center text-teal-600">
        <img src="../assets/art.png" class="w-40 h-auto">
    </div>
